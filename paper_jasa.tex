...
\begin{figure}[hbtp]
   \centering
       ...
       \caption{Comparison of the expected power of the visual test for different $K$ (number of observers) with the power of the conventional test, for $n =100$, $\sigma = 12$ and $m$=20. }
