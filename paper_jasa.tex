...
\[
E\left[ (1 - p_D)^{m-1}\right] =  \sum_{k=0}^{m-1} {m-1 \choose k} (-E[p_D])^{k} = 1-(m-1)E[p_D] + O(E[p_D^2]).
\]
...
\begin{figure*}[hbtp]
   \centering
       \scalebox{0.6}{\includegraphics{p_val_log_counts.pdf}}
       \caption{Frequency of plot picks by log$_10$ $p$-value in individual lineups}
       \label{fig:P-val_log}
\end{figure*}
