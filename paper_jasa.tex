...
\begin{figure}[hbtp]
   \centering
       ...
       \caption{Subject-specific  power estimated from model \ref{eqn:mixed} for $K=5$. The corresponding power curve for conventional test (dashed line) is shown for comparison. The overall average power curve estimated from the model is shown (light blue).}
