...
%       \includegraphics[width=0.95\textwidth]{lineup_category.pdf}
       \includegraphics[width=0.95\textwidth]{plot_turk1_300_10_12_1.png}
...
Figure \ref{fig:test_continuous} shows an example lineup for this experiment from difficulty level 4.  This lineup is generated using sample size ($n$)=100, slope($\beta$)=1.25 and and error SD($\sigma$)=5. \blue{The actual data plot location is 5. None of the 65 observers could detect the actual plot.}
...
%       \includegraphics[width=0.95\textwidth]{lineup_continuous.pdf}
       \includegraphics[width=0.95\textwidth]{plot_turk2_100_25_5_3.png}
...
An example lineup for slope $\beta=0.4$ is shown in Figure \ref{fig:test_contaminated}.  Can you pick which plot is different? \blue{The actual data plot location is 1. Out of 31 observers 13 observers could detect the actual plot.}
