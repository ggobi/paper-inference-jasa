...
Now consider estimating the power of the visual test. For the regression slope parameter $\beta$ suppose the associated $p$-value be $p_B$. The distribution of $p_B$ is a non-central $t$ distribution under $H_1$ and uniform under $H_0$. 
