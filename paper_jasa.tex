...
For several of these exceptions, along with several easy lineups, we followed up with a new experiment using an eye-tracker to examine which patterns or features participants are cueing on in making their choices \citep{zhao:2012}.
