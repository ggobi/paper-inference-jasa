...
Under the null hypothesis $X \sim Binom_{K, 1/m}$, leading to a power of \blue{(Is this power or Type I error?)}
\[
...
\blue{Another critical part is the specific question that the observer needs to answer evaluating the lineup. The question should be more than just asking to find the most different plot. Selecting the appropriate word to describe the pattern we may see when alternative hypothesis is true is important to help the observers understand what pattern they should look for. By delivering an appropriate question may reduce the type III error in an appropriate scenario.}
