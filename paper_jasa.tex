...
A \textbf{lineup} is a layout of $m$ \red{randomly placed} visual statistics, consisting of 
...
\begin{itemize}\itemsep-3pt
\item \textbf{Reject} $H_0$ if the observer selects the observed data plot in the lineup of $m$ plots, and
