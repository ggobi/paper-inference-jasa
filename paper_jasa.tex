...
%\green{Add figure showing proportion correct vs p-value of actual data plot for experiments 1 and 2.}

\green{You need to explain visual $p$-value - how is this calculated. How is this different from the signal strength. And please say why you introduce a term signal strength.}
...
\green{Be consistent with capitalization of plot labels - check this everywhere - you have lower case signal and upper case Strength}
