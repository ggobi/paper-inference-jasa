...
An example lineup for slope $\beta=0.4$ is shown in Figure \ref{fig:test_contaminated}.  Can you pick which plot is different? \blue{The actual data plot location is 1. Out of 31 observers 13 observers picked the actual plot.}
