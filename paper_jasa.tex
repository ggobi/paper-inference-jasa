...
One of the most critical steps in visual test would be select an appropriate test statistic for the hypothesis of interest.  A good test statistic should show a very specific pattern if the null hypothesis is not true. A small difference in color template or orientation of the plot could make a difference. This is the part of our ongoing and future research.
