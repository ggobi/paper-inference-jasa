...
Each subject viewed 10 lineups. Selection of lineups shown to each subject followed these rules .... \green{fill this in}. Figure \ref{fig:test_category} is an example of one of these lineups. The visual test statistic is a side-by-side boxplot.  
