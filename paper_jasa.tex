...
\begin{tabular}{cr@{.}lcc}
 ...
 Experiment & \multicolumn{2}{l}{Estimate}  &Std. error & Variance\\
  \hline
  1 & 0&39 & 0.0093 & 0.0077 \\ 
  2 & 1&22 &  0.0196 &  0.0455 \\ 
  3 & 0&39 (Intercept)  &   0.1073 & 0.1727\\ 
     & 0&33 (Slope)    &  0.0592     & \\ 
     &-0&69 (correlation) & & \\
   \hline
\end{tabular}
...
\green{Something is definitely not right! The code looks like it does actual data p-value - min(null pvalue). But how can you get a difference of 0.8 from this??}

 \green{Is this really pct correct, or 1-pct correct? When there is a big diff in p-value almost no-one gets it right! Maybe it is just a scale issue?} We see that when there is a big difference between the $p$-values observers choose the actual data plot more often.
