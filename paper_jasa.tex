...
\begin{figure}[hbtp]
   \centering
       ...
       \caption{Expected power of visual test  and the power of UMP test for sample size $n =100$ and $\sigma = 12$. \hh{what is $m$? - would it make sense to show a curves for varying values of $m$?} \blue{$m$=20 here. When $m$ changes the type-I error also changes. Thus I can produce the difference between power curves for each $m$. Do you suggest that?}}
