...
See figure \ref{still-to-do} of evidence for this phenomenon.
...
This problem is further investigated in the paper \cite{waldo}. \blue{Here is the plot in figure \ref{fig:pval_difference} as proposed.}
