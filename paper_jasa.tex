...
Lineups have been successfully applied to evaluate the power of competing graphical designs \citep{heike:2012}, and to detecting signal presence in large $p$, small $n$ data \citep{niladri:2012}. It is hoped that this proves to be  valuable in data mining applications, and exploratory analyses, where there are no existing gauges of statistical significance. 
