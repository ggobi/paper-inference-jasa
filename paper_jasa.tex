...
Now assume that individuals pick the plot that has the smallest $p$-value in the lineup plot. This leads to the decision to reject $H_0$ when $p_{B} < p_0 := \min_{i} p_{0,i}$ with  $p_0 \sim \text{Beta}(1,m-1)$. 
